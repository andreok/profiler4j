...
/**
 * Implementation of hover window that shows information abount a link.
 * 
...
public class LinkHoverWindow extends HoverWindow {
    ...
    public void prepareForElement(Object e) {
        ...
        labels[0].setText(String.format("Net: %.3fms", link.getSrc().method
            .getChildTime(link.getDst().method)));
        pack();
    }
